...
def populate_resource_license(package_dict):
 ...
 # Provo a forzare inserimento nella risorsa della rights
        if not 'rights' in res: 
         res['rights'] = 'http://publications.europa.eu/resource/authority/access-right/PUBLIC'
    return package_dict
